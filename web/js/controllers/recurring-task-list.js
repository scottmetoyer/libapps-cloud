(function() {
    // ===============================================================================
    // Controllers / RecurringTaskListCtrl
    //
  
    function RecurringTaskListCtrl($http, $scope, $state, $filter, $anchorScroll, $location, bl, data) {
      var self = this;
    ...
    angular.module('pixeladmin')
      .controller('RecurringTaskListCtrl', RecurringTaskListCtrl);
  })();